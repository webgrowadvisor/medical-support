...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            // Store file
            $file->storeAs('uploads_userfiles', $filename, 'public');

            // Save full path
            $file_url = 'uploads_userfiles/' . $filename;
        }
        ...
        if(auth()->user()->email){
            Mail::to(auth()->user()->email)->send(new BookingMail($booking));
        }
