            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Update Categories</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body general-info">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <select name="status" class="form-control" data-select2-selector="status">
                                               <option value="1" {{ isset($category) && $category->status ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ isset($category) && !$category->status ? 'selected' : '' }}>Inactive</option>                                           
                                            </select>                                             
                                        </div>
                                        @error('status') 
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('name', $category->name ?? '') }}" id="" placeholder="Categories Name">                                            
                                        </div>
                                        @error('name') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('slug', $category->slug ?? '') }}" placeholder="Categories Slug">
                                        </div>
                                        @error('slug') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <textarea name="description" id="content" class="form-control">{{ $category->description ?? '' }}</textarea>
                                        </div>
                                        @error('description') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-right">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="submit" class="submit-fix btn btn-primary" >Update Categories</button>
                                    </div>
                                </div>
                            </form>
