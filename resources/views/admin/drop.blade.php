...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Drop Shiper</h5>
                    </div>
                </div>
            ...
            <div class="main-content">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        <tbody>
                                         @foreach($drops as $key => $user)
                                            <tr class="single-item">                                                
                                                <td>
                                                {{ ($drops->currentPage() - 1) * $drops->perPage() + $key + 1 }}
                                                </td>
                                                <td>{{ $user->name }}</td>
                                                <td>{{ $user->email }}</td>                                                
                                                <td>{{ $user->mobile }}</td>                                                
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('drop.edit', $user->id) }}">
                ...
                {{ $drops->links('pagination::bootstrap-5') }}
            </div>
            <!-- [ Main Content ] end -->            
        </div>     
...
<script>        
    ...
    $(document).ready(function() { 
        ...
        $('.update-status').change(function() {
            ...
            $.ajax({
                url: '/admin/drop/' + leadId + '/update-status',
                type: 'POST',
                data: {
                    _token: XCSRF_Token,
                    status: status
