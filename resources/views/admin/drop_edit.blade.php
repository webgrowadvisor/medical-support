...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Drop/Employee</h5>
                    </div>
                    <ul class="breadcrumb">
                    ...
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="#" class="btn btn-primary successAlertMessage">
                                ...
                                <span>Create Drop/Employee</span>
                            </a>
                        </div>
                    </div>
            ...
            <!-- [ page-header ] end -->
            <!-- [ Main Content ] start -->
            <form action="{{ route('drop.update', $user->id) }}" method="post">
                @csrf
                @method('PUT')
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body general-info">
                                <div class="mb-5 d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-sm btn-light-brand">Edit Drop</a>
                                </div>
                                ...
                                <div class="row mb-4 align-items-right">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="submit" name="add_lead" class="submit-fix btn btn-primary" >Update Drop</button>
                                    </div>
                                </div>
                            </form>
