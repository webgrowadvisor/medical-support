...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Add Library</h5>
                    </div>
                    <ul class="breadcrumb">
            ...
            <!-- [ page-header ] end -->
            <!-- [ Main Content ] start -->
            <form action="{{ route('admin.libary_store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('title', $plan->title ?? '') }}" id="title" placeholder="Title Name">
                                        </div>
                                        @error('title')
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="fullnameInput" class="fw-semibold">Short Description: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="fa-solid fa-user"></i></div>
                                            <textarea name="short_description" class="form-control" placeholder="Short Description">{{ old('short_description', $plan->short_description ?? '') }}</textarea>
                                        </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="description" class="fw-semibold">Full Description: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <textarea name="full_content" id="content" class="form-control" placeholder="Full Description">{{ old('full_content', $plan->full_content ?? '') }}</textarea>
                                        </div>
                                        @error('full_content') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="cover_image" class="fw-semibold">Cover image: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="file" class="fw-semibold">File: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
