                                        ...
                                        <tbody>
                                            @forelse($medicines as $key => $medicine)
                                                <tr>
                                                    <td>{{ $key+1 }}</td>
                                                    <td>
                                                        {!! \Illuminate\Support\Str::words(nl2br($medicine->title), 5, '...') !!}
                                                    </td>
                                                    <td>
                                                        {!! \Illuminate\Support\Str::words(nl2br($medicine->short_description), 10, '...') !!}
                                                    </td>
                                                    <td>{{ $medicine->type }}</td>
                                                    <td>
                                                        <a href="{{ asset('storage/'.$medicine->file_url) }}" download class="btn btn-sm btn-info">
                                                            Download
                                                        </a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('services.edit', $medicine->id) }}"
