            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Add Medication</h5>
                    </div>
                    <ul class="breadcrumb">
                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        {{-- {!! variantImage($seller->image, 60, 60) !!} --}}
                                        @error('image') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('name', $plan->name ?? '') }}" id="fullnameInput" placeholder="Medication Name">                                            
                                        </div>
                                        @error('name') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <textarea name="description" id="content" class="form-control" placeholder="Medication Description">{{ old('description', $plan->description ?? '') }}</textarea>
                                        </div>
                                        @error('description') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('stock', $plan->stock ?? '') }}" id="stock" placeholder="Stock">
                                        </div>
                                        @error('stock') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
