...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <form action="{{ route('admin.money.decrement') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="fullnameInput" class="fw-semibold">Decrement Amount: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="fa-solid fa-user"></i></div>
                                            <input type="text" class="form-control" name="amount" 
                                            value="{{ old('amount') }}" placeholder="Decrement Amount" >
                                        </div>
                                        @error('amount') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="description" class="fw-semibold">Decrement Reason: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="fa-solid fa-file"></i></div>
                                            <textarea name="reason" class="form-control" placeholder="Decrement Reason">{{ old('reason') }}</textarea>
                                        </div>
                                        @error('reason') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-right">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="submit" class="submit-fix btn btn-primary" >Decrement Amount</button>
                                    </div>
                                </div>
                            </form>
