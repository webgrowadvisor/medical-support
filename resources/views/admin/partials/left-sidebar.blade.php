        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-caption">
                        <label>Doctors & Patient</label>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><i class="fa-solid fa-user"></i></span>
                            <span class="nxl-mtext">Patient</span><span class="nxl-arrow">
                                <i class="feather-chevron-right"></i>
                            </span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('user.list') }}">Patient</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Wallet Activity</span><span class="nxl-arrow">
                                <i class="feather-chevron-right"></i>
                            </span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.increment') }}">Increment</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.decrement') }}">Decrement</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item">
                                <a class="nxl-link" href="{{ route('admin.doctor.payouts') }}">All Payouts</a></li>                            
                        </ul>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('admin.medicines') }}" class="nxl-link">
                            <span class="nxl-micon"><i class="fa-solid fa-briefcase-medical"></i></span>
                            <span class="nxl-mtext">Medication</span><span class="nxl-arrow">
                                <i class="feather-chevron-right"></i>
                            </span>
                        </span></a>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('admin.orders') }}" class="nxl-link">
                            <span class="nxl-micon"><i class="fa-solid fa-cart-shopping"></i></span>
                            <span class="nxl-mtext">My Orders<span class="nxl-arrow">
                                <i class="feather-chevron-right"></i>
                            </span>
                        </span></a>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('admin.library') }}" class="nxl-link">
                            <span class="nxl-micon"><i class="fa-solid fa-book"></i></span>
                            <span class="nxl-mtext">Library<span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </span></a>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('admin.auditlogging') }}" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Auditlogging</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>                        
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('announcements.index') }}" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Announcements</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                    </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('protocol.index') }}" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Doctor Protocol</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>                        
                    </li>
