...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Doctor Prescriptions</h5>
                    </div>
                    <ul class="breadcrumb">
            ...
            <form action="{{ route('doctor.prescription.store') }}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="user_id" value="{{ request('user_id') ?? $apppo->user_id }}">
                            ...
                            <div class="card-body general-info">
                                <div class="mb-5 d-flex align-items-center justify-content-between">
                                    <h5 class="fw-bold mb-0 me-4">
                                        <span class="d-block mb-2">Doctor Prescription :</span>
                                    </h5>                                   
                                </div>
                                ...
                                <div id="medicine-wrapper">
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                            <label for="fullnameInput" class="fw-semibold">Medicines: <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-calendar"></i></div>                                            
                                                <input type="text" class="form-control" name="medicines[]" 
                                                value="{{ old('start_time') }}" id="medicines" placeholder="Paracetamol 500mg - 2 times">
                                ...
                                <div class="row mb-4 align-items-center">
                                    <div class="col-lg-4">
                                        <label for="start_time" class="fw-semibold">Notes: <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <textarea name="notes" id="content" class="form-control"></textarea>
                                        </div>
                                        @error('notes') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-right">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="submit" name="add_lead" class="submit-fix btn btn-primary" >Save Prescription</button>
                                    </div>
                                </div>
                            </form>
