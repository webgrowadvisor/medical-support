                                    ...
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        @forelse($prescriptions ?? [] as $key => $availability)
                                            <tr>
                                                ...
                                                <td>{{ $availability->appointment_id }}</td>
                                                 <td>
                                                ...
                                                <td>
                                                    {!! \Illuminate\Support\Str::words(nl2br($availability->notes), 10, '...') !!}
                                                </td>
                                                
                                                <td>{{ \Carbon\Carbon::parse($availability->prescription_date)->format('d M Y') }}</td>
                                                
                                                <td>
                                                    <a href="{{ route('admin.prescription.pdf', $availability->id) }}" class="btn btn-primary">
