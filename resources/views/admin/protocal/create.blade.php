...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <!-- [ page-header ] end -->
            <!-- [ Main Content ] start -->
            <form action="{{ route('protocol.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-user"></i></div>
                                            <input type="datetime-local" name="start_at" placeholder="Start At" class="form-control"> 
                                        </div>
                                        @error('start_at') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <div class="input-group-text"><i class="feather-user"></i></div>
                                            <input type="datetime-local" name="end_at" placeholder="End At" class="form-control"> 
                                        </div>
                                        @error('end_at') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
