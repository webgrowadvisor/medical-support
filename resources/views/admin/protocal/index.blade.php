            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Doctor Protocol</h5>
                    </div>
                </div>
                <div class="d-flex align-items-left gap-2 page-header-right-items-wrapper">
                    <a href="{{ route('protocol.create') }}" class="btn btn-primary">
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold">
                                            {!! \Illuminate\Support\Str::words(nl2br($announcement->description), 30, '...') !!}
                                            </h3>
                                        </div>
                                    </div>
                                    <a href="{{ route('protocol.edit', $announcement->id) }}" class="">
...
<script>        
    ...
    $(document).ready(function() { 
        ...
        $('[data-bs-id]').on('click',function(){
            ...
            $('.informationbox').load("{{url('/admin/protocol/load')}}/"+Task);
            $('.modal-title').text('Doctor Protocol');
        });
