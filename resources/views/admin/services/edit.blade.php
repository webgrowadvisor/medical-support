...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <!-- [ page-header ] end -->
            <!-- [ Main Content ] start -->
            <form action="{{ route('services.update', $plan->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <select name="service_type" class="form-control">
                                                <option {{ $plan->service_type === 'online' ? 'selected' : '' }} value="online">Online</option>
                                                <option {{ $plan->service_type === 'offline' ? 'selected' : '' }} value="offline">Offline</option>
                                            </select>
                                        </div>
                                        @error('service_type') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <select name="commission_type" class="form-control">
                                                <option {{ $plan->commission_type === 'percent' ? 'selected' : '' }} value="percent">Percentage (%)</option>
                                                <option {{ $plan->commission_type === 'fixed' ? 'selected' : '' }} value="fixed">Fixed ({{ priceicon() }})</option>
                                            </select>
                                        </div>
