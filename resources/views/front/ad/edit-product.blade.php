...
@section('content')
        ...
        <div class="nxl-content">
            ...
            <!-- [ page-header ] end -->
            <!-- [ Main Content ] start -->
            <form action="{{ route('lead.product.update', $product->id) }}" method="post">
                @csrf
                        ...
                        <div class="card stretch stretch-full">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        ...
                                        <select name="type" class="form-control" data-select2-selector="status">
                                            <option @if(old('type', $product->type) == 'Service') {{ 'selected' }} @endif value="Service">Service</option>
                                            <option @if(old('type', $product->type) == 'Product') {{ 'selected' }} @endif value="Product">Product</option>                                            
                                        </select>
                                        @error('type') 
                                        <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror 
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        ...
                                        <select id="product_life" name="produc_life" class="form-control" data-select2-selector="status">
                                            <option @if(old('produc_life', $product->produc_life) == 'Lifetime') {{ 'selected' }} @endif value="Lifetime">Lifetime</option>
                                            <option @if(old('produc_life', $product->produc_life) == 'Expirable') {{ 'selected' }} @endif value="Expirable">Expirable</option>                                            
                                        </select>
                                        @error('produc_life') 
                                        <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror 
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        ...
                                        <select id="" name="upsale" class="form-control" data-select2-selector="status">
                                            <option @if(old('upsale', $product->upsale) == 'No') {{ 'selected' }} @endif value="No">No</option>
                                            <option @if(old('upsale', $product->upsale) == 'Yes') {{ 'selected' }} @endif value="Yes">Yes</option>                                            
                                        </select>
                                        @error('upsale') 
                                        <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror 
                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            value="{{ old('product_name', $product->product_name) }}" id="fullnameInput" placeholder="Product Name">                                            
                                        </div>
                                        @error('product_name') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            id="usernameInput" placeholder="Price" name="price" value="{{ old('price', $product->price) }}">                                            
                                        </div>
                                        @error('price') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" 
                                            id="" placeholder="Quantity" name="quantity" value="{{ old('quantity', $product->quantity) }}">                                            
                                        </div>
                                        @error('quantity') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <i class="feather-link-2"></i></div>
                                            <input type="number" class="form-control" 
                                            id="" placeholder="Renewal Day" name="renwal" value="{{ old('renwal', $product->renwal) }}">
                                        </div>
                                        @error('renwal') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-center" id="days_field" style="display: none;">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <i class="feather-link-2"></i></div>
                                            <input type="number" class="form-control" 
                                            id="" placeholder="Product LifeTime Days" name="days" value="{{ old('days', $product->days) }}">                                            
                                        </div>
                                        @error('days') 
                                            <span class="text-danger text-xs mt-1">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row mb-4 align-items-right">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="submit" name="add_lead" class="submit-fix btn btn-primary" >Update Product</button>
                                    </div>
                                </div>
                            </form>
