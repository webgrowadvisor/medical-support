...
<body>
    ...
    <!--! ================================================================ !-->
    <!--<< Footer Section Start >>-->
    @include('front.partials.theme-customizer')
    <!--<< All JS Plugins >>-->
    @include('front.partials.homepage-script')
    ...
    function loadNotifications() {
        $.get("{{ route('notification.user') }}", function(res) {
    ...
    //     $.post("{{ url('/user/notification/read') }}/" + id, {
    //         _token: XCSRF_Token
    //     }, function () {
    //         loadNotifications();
    //     });
