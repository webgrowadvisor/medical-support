                            ...
                            <div class="card-body general-info">
                                ...
                                <div class="row mb-4 align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                            ...
                                            value="{{ old('dob', $user->dob ?? '') }}" placeholder="Date of Birth" readonly>
                                        @error('name') 
    ...
    $(document).ready(function() {
        ...
        $('.select2').select2({
            ...
            matcher: function(params, data) {
                ...
                if ($.trim(params.term) === '') {
                    document.getElementById('valShow').innerHTML = '';
                    return data;
                }else{
                    document.getElementById('valShow').innerHTML = params.term;
                }
