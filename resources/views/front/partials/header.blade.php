                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0">{{ userinfo()->name }} <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                        <span class="fs-12 fw-medium text-muted">{{userinfo()->email}}</span>
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="dropdown">
                            ...
                            <a href="{{ route('user.account.settings') }}" class="dropdown-item">
                            ...
                            <div class="dropdown-divider"></div>
                            <a onclick="return confirm('Are you sure you want to log out?')" href="{{ route('user.logout') }}" class="dropdown-item">
