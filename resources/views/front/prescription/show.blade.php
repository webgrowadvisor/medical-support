                                    ...
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        @forelse($prescriptions ?? [] as $key => $availability)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $availability->appointment->notes }}</br>
                                                 ...
                                                 <td>
                                                    @if ($availability->medicines === 'wait')
                                                ...
                                                <td>{!! \Illuminate\Support\Str::words(nl2br($availability->notes), 5, '...') !!}</td>
                                                
                                                <td>{{ \Carbon\Carbon::parse($availability->prescription_date)->format('d M Y') }}</td>
                                                
                                                <td>
                                                    <a href="{{ route('user.prescription.pdf', $availability->id) }}" class="btn btn-primary">
