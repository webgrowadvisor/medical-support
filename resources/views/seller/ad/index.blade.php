                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            {{ $leadsConverted }}</span>/<span class="counter">{{ $leads }}</span>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark">
                                                <span class="counter">{{ $leadsDelivered }}</span>
                                            </div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Delivered</h3>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark">{{ $Lostleads }}</div>
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">RTO & NDR</h3>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);" class="">
                                        <i class="feather-more-vertical"></i>
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action p-0">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <span class="d-block">{{ $new->full_name }}</span>
                                                            <span class="fs-12 d-block fw-normal text-muted">{{ $new->email }}</span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="badge bg-gray-200 text-dark">{{ $new->deal_stage }}</span>
                                                </td>
                                                <td>{{ $new->created_at }}</td>
                                                <td>
                                                    <span class="badge bg-soft-success text-success">{{ $new->lead_status }}</span>
                                                </td>
                                                <td class="text-end">
                                                    <a href="{{ route('leads.destroy', $new->id) }}">
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <h3>{{ 'Latest Leads Not Found' }}</h3>
                                </div>
                                @endif
                            </div>
                            @if (count($Newleads) > 10)  
                            <div class="card-footer">
                                ...
                                {{ $Newleads->links('pagination::bootstrap-5') }}
                            </div>
                            @endif
                        </div>
                    </div>
