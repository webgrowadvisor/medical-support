                                    ...
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>lead_id</th>
                                                <th>order_id</th>
                                                <th>shipment_gatway</th>
                                                <th>shipment_type | sender</th>
                                                <th>length | breadth | height</th>
                                                <th>weight</th>
                                                <th>address</th>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <a class="hstack gap-3">
                                                        ...
                                                        <div>
                                                            <span class="text-truncate-1-line">{{ $lead->lead_id }}</span>
                                                        </div>
                                                    </a>                                                    
                                                </td>
                                                ...
                                                <td>{{ $lead->shipment_gatway ?? '---' }}</td>
                                                <td>{{ $lead->shipment_type }}</br>{{ $lead->user->name }}</td>
                                                <td>L:{{ $lead->length }}</br>B:{{ $lead->breadth }}</br>H:{{ $lead->height }}</td>
                                                <td>{{ $lead->weight ?? '---' }}</td>
                                                <td >
                                                {{ $lead->address ?? '---' }}</td>
                                                <td>{{ $lead->amount ?? '---' }}</td>
