                                        ...
                                        @forelse($appointments ?? [] as $key => $appointment)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select id="profile" class="form-control w-2" data-bs-id="{{ $appointment->user->id }}" data-appointmentid="{{ $appointment->id }}" style="width: 150px; padding: 4px;" >
                                                ...
                                                <td>
                                                    {!! \Illuminate\Support\Str::words(nl2br($appointment->notes), 7, '...') !!}
                                                    @if (!empty($appointment->other))
                                                    <div>
                                                        <a href="{{ asset('storage/'.$appointment->other) }}" class="" target="_blank">
                                                ...
                                                <td>
                                                    @if ($appointment->status === 'approved' && !$isGone)
                                                        <a href="{{ route('video.call', $appointment->meeting_code) }}" data-bs-toggle="tooltip" data-bs-original-title="Join Meeting" class="btn btn-primary" target="_blank">
                                                            <i class="fa-solid fa-video"></i><span>&nbsp;Join Meeting</span>
                                                        </a>
...
<script>        
    ...
    $(document).ready(function() { 
        ...
        $('[data-bs-id]').on('change',function(){
            ...
            if(val === 'edit'){
                window.location.href = "{{url('/doctor/appointment/edit')}}/"+appointmentid;
            }
