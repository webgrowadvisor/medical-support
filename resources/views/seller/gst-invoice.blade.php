                ...
                <div class="cs-invoice_head cs-type1 cs-mb25 column border-bottom-none">
                    <div class="cs-invoice_left w-70 display-flex">
                        <div class="cs-logo cs-mb5 cs-mr20">
                            @if (sellerinfo()->logo)
                            {!! variantImage(sellerinfo()->logo, 100, 100) !!}
                            @else
                            Add Logo in Profile
                            @endif                            
                        </div>
                            ...
                            <table>
                                <thead>
                                    <tr class="cs-focus_bg">
                                        ...
                                        <th class="cs-width_1 cs-semi_bold cs-primary_color">SKU</th>
                                ...
                                @foreach($orderDetails as $item)
                                    @php
                                        $rate = $item['order']->price ?? $item['variant']->price;
                                        $qty = $item['order']->quantity;
                                        $taxable = $rate * $qty;

                                        $cgst_rate = ($item['product']->cgst ?? 6.00) / 100;
                                        $sgst_rate = ($item['product']->sgst ?? 6.00) / 100;
