                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>                                            
                                            ...
                                            <p class="fs-13 fw-semibold">{!! \Illuminate\Support\Str::words(nl2br($announcement->description), 30, '...') !!}</p>
                                        </div>
                                    </div>
...
<script>        
    ...
    $(document).ready(function() { 
        ...
        $('[data-bs-id]').on('click',function(){
            ...
            $('.informationbox').load("{{url('/doctor/protocol/load')}}/"+Task);
            $('.modal-title').text('Protocal');
        });
