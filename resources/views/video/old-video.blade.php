...
{{-- <h2>Video Call</h2> --}}
{{-- <h3>Call Time: <span id="timer">0:00</span></h3> --}}
...
{{-- <div class="button-div call-animation">
    <button onclick="toggleMic()" id="micBtn">Mic
        <i class="fa-solid fa-microphone"></i>
    </button>
    <button onclick="holdCall()" id="holdBtn">Hold</button>
    <button onclick="resumeCall()" id="resumeBtn">Resume</button>
    <button onclick="endCall()" id="endBtn" >End</button>
</div> --}}
...
setInterval(() => {
    ...
    .then(room => {
        ...
        // container.innerHTML = ""; // clear before attaching
        // // 🔥 LOCAL VIDEO ONLY
    ...
    function handleParticipant(participant) {
        ...
        participant.on('trackSubscribed', track => {
            if (track.kind === 'video') {
                ...
                // 🔥 remove old remote video instantly
                remoteContainer.innerHTML = "";
    ...
    //     const element = track.attach();
    //     element.id = track.sid; // unique id
