...
Route::middleware(['auth:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/medicines/create', [MedicineController::class, 'create'])->name('admin.medicine.create');
    Route::post('/medicines/store', [MedicineController::class, 'store'])->name('admin.medicine.store');
    Route::get('/medicines/edit/{id}', [MedicineController::class, 'edit'])->name('admin.medicines.edit');
    Route::post('/medicines/update/{id}', [MedicineController::class, 'update'])->name('admin.medicines.update');

    Route::get('/library', [MedicineController::class, 'library'])->name('admin.library');
    Route::get('/library/create', [MedicineController::class, 'library_create'])->name('admin.library.create');
    Route::post('/library', [MedicineController::class, 'libary_store'])->name('admin.libary_store');

    Route::get('/orders', [MedicineController::class, 'orderList'])->name('admin.orders');
    Route::get('/orders/view/{order}', [MedicineController::class, 'orderView'])->name('admin.orderView');
    Route::post('/admin/order-status/{id}', [MedicineController::class, 'updateStatus'])->name('admin.order.status');
...
Route::middleware(['auth:seller'])->prefix('doctor')->group(function () {
    ...
    Route::post('/appointments/{id}/update', [DoctorScheduleController::class, 'editAppointment'])->name('doctor.appointments.update');
    ...
    Route::get('/appointment/edit/{id}', [SellerController::class, 'appointment_edit'])->name('doctor.appointment_edit');
...
// user patient
Route::middleware(['web', 'auth:web'])->prefix('patient')->group(function () {
    ...
    Route::get('/service-catalog', [UserController::class, 'service_catalog'])->name('user.service_catalog');

    Route::get('/medicines', [UserController::class, 'medicine_list'])->name('user.medicines');
    Route::post('/medicine/buy', [UserController::class, 'buy_medicine'])->name('user.medicine.buy');
    Route::get('/orders', [UserController::class, 'orderList'])->name('user.orders');
    Route::get('/orders/view/{order}', [UserController::class, 'orderView'])->name('user.orderView');

    Route::get('/library', [UserController::class, 'libary'])->name('user.library');
    Route::get('/library/load/{id}', [UserController::class, 'library_load'])->name('user.library.load');

});


    Route::get('/video/{uuid?}', [UserController::class, 'getvideo'])->name('video.call');
    Route::post('/video-token', [UserController::class, 'generateToken']);


    Route::get('/patient/singup', function () { 
        if(auth()->check()){
    ...
    Route::post('/patient/check', [AuthController::class, 'user_check'])->name('user.check');
